...
"use strict";function validateExtension(a,b){for(var c=a.split(".").pop(),d=0;d<b.length;d++)if(b[d]===c)return!0;return!1}var ngSchemaFormFileType=angular.module("ngSchemaFormFileType",["angularFileUpload"]);angular.module("schemaForm").config(["schemaFormProvider","schemaFormDecoratorsProvider","sfPathProvider",function(a,b){b.addMapping("bootstrapDecorator","files","files.html");var c=function(a,b){"array"===b.type&&"files"===b.format&&(void 0!==b.items.properties.size&&void 0!==b.items.properties.size.maximum&&(b.items.properties.size.validationMessage={103:"This file is too large. Maximum size allowed is "+Math.floor(b.items.properties.size.maximum/1e3)+" ko."}),void 0!==b.items.properties.extension&&void 0!==b.items.properties.extension["enum"]&&(b.items.properties.extension.validationMessage={1:"Wrong file extension. Allowed extensions are "+b.items.properties.extension["enum"]+"."}),void 0!==b.maxItems&&(b.validationMessage={401:"You can't upload more than "+b.maxItems+" files."}))};a.defaults.array.unshift(c)}]),ngSchemaFormFileType.directive("ngSchemaFile",["$upload","$timeout","$q",function(a,b,c){return{restrict:"A",scope:!0,require:"ngModel",link:function(d){d.fileReaderSupported=null!=window.FileReader&&(null==window.FileAPI||0!=FileAPI.html5),d.upload=function(a){var b=d.form.key[0];d.model[b]=[];for(var c=0;c<a.length;c++){var e=a[c],f=e.name.split(".").pop();d.model[b].push({token:c.toString(),extension:f,size:e.size,name:e.name,progress:0}),d.generateThumb(e,c).then(function(a){d.model[b][a.i].dataUrl=a.dataUrl}),void 0!==d.form.schema.items.properties.size&&void 0!==d.form.schema.items.properties.size.maximum&&d.form.schema.items.properties.size.maximum<e.size||(void 0===d.form.schema.items.properties.extension||void 0===d.form.schema.items.properties.extension["enum"]||validateExtension(e.name,d.form.schema.items.properties.extension["enum"]))&&d.uploadFile(e,b,c).then(function(a){d.model[b][a.index].token=a.token,d.model[b][a.index].extension=a.extension,d.model[b][a.index].size=a.size})}d.revalidate()},d.uploadFile=function(b,e,f){var g=c.defer();return a.upload({url:d.form.endpoint,file:b,fields:{index:f}}).progress(function(a){var b=parseInt(100*a.loaded/a.total);a.config.file.filesProgress=b,d.model[e][a.config.fields.index].progress=b}).success(function(a){g.resolve(a)}),g.promise},d.generateThumb=function(a,e){var f=c.defer();return null!=a&&d.fileReaderSupported&&a.type.indexOf("image")>-1&&b(function(){var c=new FileReader;c.readAsDataURL(a),c.onload=function(c){b(function(){a.dataUrl=c.target.result,f.resolve({dataUrl:a.dataUrl,i:e})})}}),f.promise},d.revalidate=function(){b(function(){d.$broadcast("schemaFormValidate")},100)}}}}]);
